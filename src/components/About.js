                ...
                <div className="row">
                    <div className="col-lg-8 col-md-12 col-sm-12">
                        ...
                        <p className="p-2">Hello! My name is Tayo and I enjoy creating things that live on the internet. My
                            ...
                            personally before a friend taught me a lot about HTML & CSS. My main focus
                            these days is
                            building accessible, inclusive products and digital experiences for a variety of
                            client.
                            <br/> <br/>
                            Fast-forward to today, I’ve had the privilege of working at a logistic agency, a start-up, and a cryptocurrency educational platform. My main focus these days is building accessible, inclusive products and digital experiences at Upstatement for a variety of clients.
                            </p>
                    </div>
